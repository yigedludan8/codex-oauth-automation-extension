...
const rowSignupPhoneTempNumber = document.getElementById('row-signup-phone-temp-number');
...
function collectSettingsPayload() {
  ...
  const signupPhoneUseTempNumberValue = typeof inputSignupPhoneUseTempNumber !== 'undefined' && inputSignupPhoneUseTempNumber
    ? Boolean(inputSignupPhoneUseTempNumber.checked)
    : Boolean(latestState?.signupPhoneUseTempNumber);
  const signupPhoneTempNumberDurationHoursValue = typeof inputSignupPhoneTempNumberDurationHours !== 'undefined' && inputSignupPhoneTempNumberDurationHours
    ? normalizeSignupTempNumberDurationHoursValue(
      inputSignupPhoneTempNumberDurationHours.value,
      latestState?.signupPhoneTempNumberDurationHours
    )
    : normalizeSignupTempNumberDurationHoursValue(latestState?.signupPhoneTempNumberDurationHours);
  ...
  return {
    ...
    signupPhoneUseTempNumber: signupPhoneUseTempNumberValue,
    signupPhoneTempNumberDurationHours: signupPhoneTempNumberDurationHoursValue,
...
function normalizeSignupTempNumberDurationHoursValue(value, fallback = DEFAULT_SIGNUP_TEMP_NUMBER_DURATION_HOURS) {
  const rawValue = String(value ?? '').trim();
  const parsed = Number.parseInt(rawValue, 10);
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        SIGNUP_TEMP_NUMBER_DURATION_HOURS_MAX,
        Number(fallback) || DEFAULT_SIGNUP_TEMP_NUMBER_DURATION_HOURS
      )
    );
  }
  return Math.max(
    SIGNUP_TEMP_NUMBER_DURATION_HOURS_MIN,
    Math.min(SIGNUP_TEMP_NUMBER_DURATION_HOURS_MAX, parsed)
  );
}
...
function updatePhoneVerificationSettingsUI() {
  ...
  const phoneVerificationRows = [
    typeof rowSignupPhoneTempNumber !== 'undefined' ? rowSignupPhoneTempNumber : null,
  ...
  if (typeof rowSignupPhoneTempNumber !== 'undefined' && rowSignupPhoneTempNumber) {
    rowSignupPhoneTempNumber.style.display = showSettings && currentSignupMethod === SIGNUP_METHOD_PHONE ? '' : 'none';
  }
  if (typeof inputSignupPhoneTempNumberDurationHours !== 'undefined' && inputSignupPhoneTempNumberDurationHours) {
    inputSignupPhoneTempNumberDurationHours.disabled = !(
      showSettings
      && currentSignupMethod === SIGNUP_METHOD_PHONE
      && Boolean(inputSignupPhoneUseTempNumber?.checked)
    );
  }
...
function applySettingsState(state) {
  ...
  if (typeof inputSignupPhoneTempNumberDurationHours !== 'undefined' && inputSignupPhoneTempNumberDurationHours) {
    inputSignupPhoneTempNumberDurationHours.value = String(
      normalizeSignupTempNumberDurationHoursValue(
        state?.signupPhoneTempNumberDurationHours,
        DEFAULT_SIGNUP_TEMP_NUMBER_DURATION_HOURS
      )
    );
  }
...
inputSignupPhoneUseTempNumber?.addEventListener('change', () => {
  updatePhoneVerificationSettingsUI();
  markSettingsDirty(true);
  saveSettings({ silent: true }).catch(() => { });
});

inputSignupPhoneTempNumberDurationHours?.addEventListener('input', () => {
  markSettingsDirty(true);
  scheduleSettingsAutoSave();
});

inputSignupPhoneTempNumberDurationHours?.addEventListener('blur', () => {
  inputSignupPhoneTempNumberDurationHours.value = String(
    normalizeSignupTempNumberDurationHoursValue(
      inputSignupPhoneTempNumberDurationHours.value,
      DEFAULT_SIGNUP_TEMP_NUMBER_DURATION_HOURS
...
chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
  switch (message.type) {
    ...
    case 'DATA_UPDATED': {
      ...
      if (message.payload.signupPhoneUseTempNumber !== undefined && inputSignupPhoneUseTempNumber) {
        inputSignupPhoneUseTempNumber.checked = Boolean(message.payload.signupPhoneUseTempNumber);
      }
      if (message.payload.signupPhoneTempNumberDurationHours !== undefined && inputSignupPhoneTempNumberDurationHours) {
        inputSignupPhoneTempNumberDurationHours.value = String(
          normalizeSignupTempNumberDurationHoursValue(
            message.payload.signupPhoneTempNumberDurationHours,
            DEFAULT_SIGNUP_TEMP_NUMBER_DURATION_HOURS
          )
        );
      }
      ...
      if (
        ...
        || message.payload.signupPhoneUseTempNumber !== undefined
        || message.payload.signupPhoneTempNumberDurationHours !== undefined
